...
@section('content')
    ...
    <div class="col-md-12">
        ...
        <form action="#" method="post">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title"> 基金总份额（亿份）</label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title"> 上市流通份额（亿份）</label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title"> 基金规模（亿元）</label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title"> 选股风格</label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title"> 基金管理人</label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title"> 基金托管人</label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title"> 运作方式</label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title"> 基金类别</label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title"> 二级分类</label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title">代销机构 </label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title"> 最代参与金额</label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title"> 代赎回金额</label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title"> 投资目标</label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="title"> 基金比较基准</label>
                    <input class="form-control" type="text" name="title" id="title">
                </div>
            </div>
